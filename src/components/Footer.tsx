      ...
      <div className="max-w-7xl mx-auto px-8 md:px-14 pt-20 pb-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-3">
              {[Instagram, Twitter, Facebook].map((Icon, i) => (
                <a key={i} href="#" className="w-9 h-9 rounded-lg border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-brand-gold/40 hover:bg-brand-gold/10 transition-all duration-300">
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-mono text-[9px] uppercase tracking-[0.35em] text-white/25">
            © 2024 MilletFam Agro Products. All Rights Reserved.
          </p>
          <div className="flex gap-6">
            {['Privacy Policy', 'Terms', 'Track Order'].map(l => (
              <a key={l} href="#" className="font-mono text-[9px] uppercase tracking-[0.25em] text-white/25 hover:text-white/60 transition-colors">
                {l}
              </a>
            ))}
          </div>
